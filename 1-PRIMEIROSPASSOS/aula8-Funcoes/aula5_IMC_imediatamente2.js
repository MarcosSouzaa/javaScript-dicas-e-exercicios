//FUNÇÕES INVOCADAS IMEDIATAMENTE2
/*
...
/*
FUNÇÃO IMEDIATAMENTE INVOCADA ELA CRIA E SE EXECUTA SEM PRECISAR CHAMAR
ESSE CÓDIGO ESTÁ ISOLADO COMO 10 * (2+5), PRIMEIRO RESOLVE-SE O QUE ESTÁ ISOLADO.
POSSO INCLUSIVE, TIRAR O NOME DA FUNÇÃO.
Será uma função não nomeada, ou função anônima ou função Lâmbida.
*/
(function() {
    const peso = 87;
    const altura = 1.87;
